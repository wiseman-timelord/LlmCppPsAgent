...
3) Reporting of temps on, CPU & GPU, each loop through LibreOpenHardwareMonitor, this will allow users to notice if there are issues with their cooling setup, and allow them to correct this before, damage or crash, as I said, most modern games dont test modern hardware, when compared to running LLMs.
