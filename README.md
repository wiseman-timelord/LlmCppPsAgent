...
3) Reporting of temps on, CPU & GPU, each loop through LibreOpenHardwareMonitor, this will allow users to notice if there are issues with their cooling setup, and maybe even some kind of over 80c warning, as around there will sometimes crash, and little over that could damage hardware, "o" to over-ride, like in MechWarrior! (O_o/' 
